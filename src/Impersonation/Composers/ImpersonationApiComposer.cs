...
public class ImpersonationApiComposer : IComposer
{
    public void Compose(IUmbracoBuilder builder)
    {
        ...
        builder.Services.Configure<SwaggerGenOptions>(opt =>
        {
            ...
            {
                Title = "Impersonation Backoffice API", Version = "1.0"
            ...
            opt.OperationFilter<PackageStarterOperationSecurityFilter>();
        });
    }

    public class PackageStarterOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
    {
    ...
    public class CustomOperationHandler : OperationIdHandler
    {
        ...
        {
            return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Impersonation.Controllers",
